...
SECRET_KEY = 'django-insecure-b+ru%$=ys4h-s(6c_+2prhonjfxbe36!=ne=ea!+u_)pq1v1gb'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=2),  # Access token expires after 30 minutes
